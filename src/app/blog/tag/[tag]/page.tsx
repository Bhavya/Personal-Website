...
export const generateMetadata = async ({ params }: BlogTagPageProps): Promise<Metadata> => {
    ...
    const title = `Bhavya Blog - ${capita}`
    const description = `Explore a collection of articles and blog posts with tag ${capita} by Bhavya. Discover more ${capita} related blogs.`
